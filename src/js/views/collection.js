...
export const Collection = () => {
  ...
  return (
    <div>
      ...
      <div>
        <p
          className="subscription border rounded text-danger"
          role="button"
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title id="example-modal-sizes-title-lg" className="Title2">
              Subscribe to our Latest Hits{" "}
              <i className="fa fa-music text-danger" />
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <FloatingLabel
            ...
            <Alert show={show} variant="success">
              ...
              <p>
                You have successfully subscribed to your monthly news on our
                latest hits!
              </p>
              <hr />
